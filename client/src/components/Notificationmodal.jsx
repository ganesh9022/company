...
const Notificationmodal = () => {
  const List = [
    {
      id: 1,
      message: "Your leave application is apporved",
      profile: "leave.svg",
      time: "2H",
    },
  ...
  return (
    ...
    >
      <DropdownMenu.Trigger asChild>
        <button
          className="IconButton notification hidden md:flex items-center mr-3 rounded-full p-2 cursor-pointer"
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          className="DropdownMenuContent modal-content"
          sideOffset={5}
        >
